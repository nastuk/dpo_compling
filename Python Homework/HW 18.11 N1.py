import re
addresses = '''Nordstrom Rack and HauteLook
Nordstrom Rack is the off-price retail division of Nordstrom Inc., 
which was founded in 1901 in Seattle, Washington, by John W. Nordstrom.
...
result = re.findall(r"[0-9]{3,4}\s.+\sSuite\s[0-9]{3,4}\s.+[A-Z]{2}\s[0-9]{5}", addresses)
print(*result, sep='\n')
